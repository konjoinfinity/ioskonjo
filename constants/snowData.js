export default snowData = [ 
        ...
        },
        {
            ...
            kind: 'Tricky Snow ❅',
            title: 'Ice',
            desc: 'Snow so hard and cold as to resemble ice; tough to hold an edge; Actual ice is very rare.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 76,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Shmoo',
            desc: 'Warm, unpleasant snow, old cut powder with freeze/thaw; A less-slushy slush.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 77,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Slush',
            desc: 'Warm, melting spring-time snow so wet and sloppy, can result in rapid deceleration.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 78,
            ...
            acronymn: "CHO",
            kind: 'Tricky Snow ❅',
            title: 'Chowder Powder (Chowdah Powdah)',
            desc: 'Thick, heavy, chunky snow typical of New England states.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 79,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Verglas',
            desc: 'Thin layer of ice over older snow underneath. Tricky to say the least; Rare, thankfully!',
            backgroundColor: "#ECECEC"
        },
        {
            key: 80,
            ...
            acronymn: "NE",
            kind: 'Tricky Snow ❅',
            title: 'New England	Hard Pack',
            desc: `Euphemism for "Ice";	That way, it's not so scary sounding.`,
            backgroundColor: "#ECECEC"
        },
        {
            key: 81,
        ...
        },
        {
            ...
            kind: 'Tricky Snow ❅',
            title: 'Sticky',
            desc: 'Wet snow with high coeffient of friction; like riding thru gluey	"slime" (the toy).',
            backgroundColor: "#ECECEC"
        },
        {
            key: 83,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Blue',
            desc: 'Actual clear ice, and the ground is visible through it; Bring your ice skates; Rare.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 84,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Ball Bearings',
            desc: 'Frozen hard little balls	of snow or ice on the surface; Imagine all the fun skiing this!',
            backgroundColor: "#ECECEC"
        },
        {
            key: 85,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Glop',
            desc: 'Snow that thaws, refreezes and clings to ski bottoms; Largely reduces glide.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 86,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Avi Debris',
            desc: 'Snow aftermath of an avalanche; very chunky, heavy, inconsistant; Not good.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 87,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Heavy Snow',
            desc: 'Dense snow with a high moisture content of 11% or greater; Hard to ski well in it.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 88,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Death Cookies',
            desc: 'Frozen chunks left behind by grooming operations, "real fun".',
            backgroundColor: "#ECECEC"
        },
        {
            key: 89,
            ...
            acronymn: "WI",
            kind: 'Tricky Snow ❅',
            title: 'Wind Slab (Wind Crust)',
            desc: 'A stiff, hard surface layer of snow created by strong wind.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 90,
            ...
            acronymn: "CRU",
            kind: 'Tricky Snow ❅',
            title: 'Crushed Soda Cans',
            desc: '(aka, Death Cookies)	Frozen chunks of "Real bad news".',
            backgroundColor: "#ECECEC"
        },
        {
            key: 91,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Smud',
            desc: 'Mix of mud and snow,	nasty brown surface; kind of skiable...',
            backgroundColor: "#ECECEC"
        },
        {
            key: 92,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Rotten Snow',
            desc: 'Old snow that is wet, sloppy; Big time into the freeze-thaw cycle.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 93,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Chicken Heads',
            desc: 'Refrozen clumps or ridges of snow that resemble the heads of the titled fowl.',
            backgroundColor: "#ECECEC"
        },
        {
            key: 94,
            ...
            kind: 'Tricky Snow ❅',
            title: 'Early Snow',
            desc: 'First snow of the new season; Variable thin cover; Can be scary without "ski legs".',
            backgroundColor: "#ECECEC"
        },
        {
            key: 95,
        ...
        },
        {
            ...
            kind: 'You Call This Snow? ❅',
            title: 'WTF Snow',
            desc: 'Deceiving conditions	that look good, until you try to go or move	or turn or stop or...',
            backgroundColor: "#FEF2CB"
        },
        {
            key: 98,
            ...
            kind: 'You Call This Snow? ❅',
            title: 'Plastic Snow',
            desc: 'Truly artificial, "dry" ski surface; Extruded plastic tiles, mats, carpet, or the like.',
            backgroundColor: "#FEF2CB"
        },
        {
            key: 99,
            ...
            kind: 'You Call This Snow? ❅',
            title: 'Mars',
            desc: '"Phoenix" Mars lander observed water-based snow crystals there; Yup, on Mars!!',
            backgroundColor: "#FEF2CB"
        },
        {
            key: 100,
            ...
            acronymn: "GOD",
            kind: 'You Call This Snow? ❅',
            title: "God's Dandruff",
            desc: "Legend has it that if rain is His tears, snow is God's dandruff; Please, don't shampoo.",
            backgroundColor: "#FEF2CB"
        },
        {
            key: 101,
