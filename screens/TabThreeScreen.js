      ...
      <View>
          ...
          style={{
            height:
              Dimensions.get("window").height > 1000
                ? Dimensions.get("window").height * 0.89
        ...
        >
          <TouchableOpacity
            ...
            appearance="filled"
            onPress={() => navigation.navigate("ModalAddNote")}
          >
            <MIcon
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <Text
                                style={{ color: colors.text, paddingBottom: 2 }}
                              >
                                {log.dateCreated}
                              </Text>
                            </View>
                          ...
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              navigation.navigate("ModalEditNote", {
                                number: id,
                                loggy: log,
                              });
                            }}
